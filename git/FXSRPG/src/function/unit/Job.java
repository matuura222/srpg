 ...
 * @author 樹麗
 */
public class Job extends GameData implements IgetSkillIdListdable {
	 ...
	 */
	@JsonCreator
	public Job(@JsonProperty("id") String id, @JsonProperty("name") String name, @JsonProperty("hp_up") double hp_up,
	 ...
	 * @return Jobの基本値を返す
	 */
	public static Job defaultData() {
		return new Job("", "", 0, 0, 0, 0, 0, 0, new ArrayList<String>(), 0);
	}
	/* (非 Javadoc)
	 * @see function.GameData#getDefaultData()
	 */
	@Override
	public Job getDefaultData() {
		return defaultData();
	}
}
